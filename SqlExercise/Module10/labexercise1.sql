CREATE FUNCTION dbo.FormatPhoneNumber(@PhoneNumberToFormat nvarchar(16))
RETURNS nvarchar(16)
AS
BEGIN
...
SELECT dbo.FormatPhoneNumber('+91 9 5685-4321');
SELECT dbo.FormatPhoneNumber('123 456-2345');